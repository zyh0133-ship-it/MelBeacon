...
// 自动化任务数据（V5.0：同步真实定时任务，按平台分组，含 scheduled_task_id）
// 数据来源：TRAE Schedule 引擎创建的13个真实定时任务（2026-07-30 同步）
const automationTasks = [
  // ===== 小红书平台（5个任务）=====
  { id: 'auto_xhs_01', name: '小红书低粉爆款每日搜集', platform: '小红书', status: 'running', schedule: '每天 07:00', lastRun: '待首次运行', nextRun: '2026-07-31 07:00', target: '小红书·激活赛道', targetRoles: ['social'], taskType: 'daily', desc: '搜集粉丝<5000但互动>500的低粉爆款笔记，提取选题灵感', scheduled_task_id: 'e362c258' },
  { id: 'auto_xhs_02', name: '小红书赛道热度日报', platform: '小红书', status: 'running', schedule: '每天 15:00', lastRun: '待首次运行', nextRun: '2026-07-30 15:00', target: '小红书·激活赛道', targetRoles: ['social'], taskType: 'daily', desc: '各赛道热度、竞争度、机会指数、爆款率分析', scheduled_task_id: '1e5d1147' },
  { id: 'auto_xhs_03', name: '小红书对标账号每周搜索', platform: '小红书', status: 'running', schedule: '每周一 10:00', lastRun: '待首次运行', nextRun: '2026-08-03 10:00', target: '小红书·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '搜索同赛道优质对标账号，输出账号画像和内容分析', scheduled_task_id: '166d90af' },
  { id: 'auto_xhs_04', name: '小红书选题库周报', platform: '小红书', status: 'running', schedule: '每周二 10:00', lastRun: '待首次运行', nextRun: '2026-08-04 10:00', target: '小红书·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '整理对标账号优质内容，提炼可复用选题清单', scheduled_task_id: 'cbf8f45c' },
  { id: 'auto_xhs_05', name: '小红书对标账号动态监控', platform: '小红书', status: 'running', schedule: '每周一 09:00', lastRun: '待首次运行', nextRun: '2026-08-03 09:00', target: '小红书·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '监控已收录对标账号最新发布内容，追踪内容方向变化', scheduled_task_id: '437eb506' },
  // ===== 抖音平台（4个任务）=====
  { id: 'auto_dy_01', name: '抖音低粉爆款每日搜集', platform: '抖音', status: 'running', schedule: '每天 07:00', lastRun: '待首次运行', nextRun: '2026-07-31 07:00', target: '抖音·激活赛道', targetRoles: ['social'], taskType: 'daily', desc: '搜集低粉爆款视频，提取选题灵感和内容结构', scheduled_task_id: 'b5396620' },
  { id: 'auto_dy_02', name: '抖音赛道热度日报', platform: '抖音', status: 'running', schedule: '每天 15:00', lastRun: '待首次运行', nextRun: '2026-07-30 15:00', target: '抖音·激活赛道', targetRoles: ['social'], taskType: 'daily', desc: '各赛道热度、竞争度、机会指数分析', scheduled_task_id: '371d1f98' },
  { id: 'auto_dy_03', name: '抖音对标账号每周搜索', platform: '抖音', status: 'running', schedule: '每周一 10:00', lastRun: '待首次运行', nextRun: '2026-08-03 10:00', target: '抖音·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '搜索同赛道优质对标账号，输出账号画像和内容分析', scheduled_task_id: '4d4dcfe0' },
  { id: 'auto_dy_04', name: '抖音选题库周报', platform: '抖音', status: 'running', schedule: '每周二 10:00', lastRun: '待首次运行', nextRun: '2026-08-04 10:00', target: '抖音·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '整理对标账号优质内容，提炼可复用选题清单', scheduled_task_id: '935fa6d7' },
  // ===== B站平台（4个任务）=====
  { id: 'auto_bili_01', name: 'B站低粉爆款每日搜集', platform: 'B站', status: 'running', schedule: '每天 07:00', lastRun: '待首次运行', nextRun: '2026-07-31 07:00', target: 'B站·激活赛道', targetRoles: ['social'], taskType: 'daily', desc: '搜集低粉爆款视频，提取选题灵感和内容结构', scheduled_task_id: '9aaab19f' },
  { id: 'auto_bili_02', name: 'B站赛道热度日报', platform: 'B站', status: 'running', schedule: '每天 15:00', lastRun: '待首次运行', nextRun: '2026-07-30 15:00', target: 'B站·激活赛道', targetRoles: ['social'], taskType: 'daily', desc: '各赛道热度、竞争度、机会指数分析', scheduled_task_id: '5416ae74' },
  { id: 'auto_bili_03', name: 'B站对标账号每周搜索', platform: 'B站', status: 'running', schedule: '每周一 10:00', lastRun: '待首次运行', nextRun: '2026-08-03 10:00', target: 'B站·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '搜索同赛道优质对标账号，输出账号画像和内容分析', scheduled_task_id: '5bf9d33e' },
  { id: 'auto_bili_04', name: 'B站选题库周报', platform: 'B站', status: 'running', schedule: '每周二 10:00', lastRun: '待首次运行', nextRun: '2026-08-04 10:00', target: 'B站·激活赛道', targetRoles: ['social'], taskType: 'weekly', desc: '整理对标账号优质内容，提炼可复用选题清单', scheduled_task_id: 'ff9a566a' }
];
